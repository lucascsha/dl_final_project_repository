...
def get_args():
    ...
    #hyperparameters
    parser.add_argument('--batch_size', type=int, default= 30, help= 'Batch size of data') #Use batch_size = 30 and l_r = 1e-4 FOR BASE MODEL WO PERSONALIZATION
    parser.add_argument('--optimizer', type=str, default= 'adam', help= 'Optimizer used to update gradients')
    parser.add_argument('--learning_rate', type=float, default= 1.1e-4, help= 'Model learning rate')
...
def train(args):
    ...
    #cp_callback = set_checkpoint(args)
    ...
    #validation 
        ...
        #cp_callback.on_epoch_end(epoch, logs={'val_loss': loss})

    #cp_callback.on_train_end()
